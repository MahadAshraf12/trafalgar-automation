...
const INPUT_FILE = join(__dirname, 'insight-tours-us.json');
const OUTPUT_FILE = join(__dirname, 'trip_sku_latest_us.json');
...
async function extractLatestSkus() {
  try {
    console.log('📂 Reading Insight Vacations tour data...');
