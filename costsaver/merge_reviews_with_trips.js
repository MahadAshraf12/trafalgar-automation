...
function readTripsData() {
  const tripsFile = path.join(process.cwd(), 'trips_costsaver.json');
...
function readReviewsData() {
  const reviewsFile = path.join(process.cwd(), 'feefo_reviews_costsaver.json');
...
function saveEnhancedTrips(enhancedTrips) {
  const outputFile = path.join(process.cwd(), 'trips_with_reviews_costsaver.json');
